export const contentMarketingData = {
  ...
  subheadline: 'Every GEO citation needs a source. Every AEO answer needs a page. Every SEO ranking needs content behind it. We build the content infrastructure that powers all of it\u2014and converts the humans who arrive.',
  ctaSecondary: 'See How Content Works',
  intro: {
    label: 'The Approach',
    headline: 'Content built for humans and AI engines\u2014equally.',
    body: [
      "Content marketing has always been about creating material that earns attention, builds trust, and drives action. What\u2019s changed is who\u2014and what\u2014you need to earn that attention from.",
      "Today, great content needs to perform on three surfaces simultaneously: it needs to rank in Google (SEO), be selected as the authoritative answer by AI engines (GEO + AEO), and convert the human who ultimately reads it. Most content fails at least one of these. Often all three.",
    ...
    calloutStat: '3\u00d7',
    calloutText: 'more leads than outbound marketing\u2014at 62% less cost. But only when it\u2019s built with a strategy. Random content creates random results. Structured content infrastructure compounds.',
  },
  comparison: {
    without: { title: 'Random Content Creation', items: ['Blog posts written without keyword strategy', 'Content that ranks but doesn\u2019t convert', 'AI engines ignore or misrepresent your content', 'No amplification after publish', 'Vanity metrics: page views'] },
    with: { title: 'MyAibo Content Infrastructure', items: ['Every piece mapped to a search demand cluster', 'Copy architecture optimised for ranking and conversion', 'Content structured for AI citation and summarisation', 'Distribution across owned, earned, and AI surfaces', 'Business metrics: leads, revenue, citations'] },
  },
  process: {
    label: 'Our Process',
  ...
  deliverables: {
    ...
    cards: [
      ...
      { title: 'Thought Leadership', body: "Executive bylines, industry perspectives, and opinion pieces placed in authoritative publications\u2014building your brand\u2019s human credibility alongside its technical SEO authority." },
      ...
      { title: 'Email & Nurture Sequences', body: 'Content that converts at every stage of the funnel\u2014welcome sequences, educational drips, re-engagement campaigns\u2014written to move prospects closer to a decision without feeling like marketing.' },
      { title: 'Video Scripts & Multimedia Briefs', body: 'Scripts and briefs for explainer videos, social shorts, webinars, and podcast episodes\u2014so your content strategy extends to every format your audience uses.' },
    ],
  },
  whyNow: {
    label: 'The Case for Content',
    headline: 'Content is the raw material of every other channel.',
    stats: [
      { num: '3\u00d7', label: 'Leads generated by content marketing vs outbound, at 62% lower cost' },
      { num: '92%', label: 'Of GEO citations draw from long-form, structured content sources' },
      { num: '6\u201312 mo', label: 'Typical compounding horizon where content outperforms all paid channels' },
    ...
    contextCards: [
      ...
      { title: 'The Compounding Effect', body: 'Unlike paid advertising, content accrues value over time. A well-built pillar page earns backlinks, rankings, and citations for months or years after it\u2019s published. The content you build today is still working in 2027.' },
  ...
  results: {
    ...
    headline: 'Content that moves every metric that matters.',
    metrics: [
      { metric: 'Organic traffic from content (12 months)', result: '+220% average' },
      { metric: 'GEO citation appearances from content pieces', result: '+190%' },
      { metric: 'Email engagement rate (content-led sequences)', result: '+47% avg open rate' },
    ...
    testimonial: {
      ...
      author: 'Founder, Trudiance Beauty',
      role: 'D2C Skincare & Makeup',
      initials: 'TB',
    },
  },
  finalCta: {
    headline: 'Ready to build content that actually works?',
    body: "Start with a free content audit. We\u2019ll review your existing content library, identify what\u2019s underperforming and why, and show you what a strategy built around your specific growth goals would look like.",
    ctaSecondary: 'Get a Free Content Audit First',
  },
};

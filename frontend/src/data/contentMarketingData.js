export const contentMarketingData = {
  ...
  comparison: {
    without: { title: 'Random Content Creation', items: [
      'Blog posts written without keyword strategy',
      'Content that ranks but doesn\u2019t convert',
      'AI engines ignore or misrepresent your content',
      'No amplification after publish',
      'Vanity metrics: page views',
    ]},
    with: { title: 'MyAibo Content Infrastructure', items: [
      'Every piece mapped to a search demand cluster and business outcome',
      'Copy architecture optimised for both AI engines and human readers',
      'Content structured for AI citation, summarisation, and extraction',
      'Distribution across owned, earned, and AI surfaces from day one',
      'Business metrics: leads, revenue, and AI citations',
    ]},
  },
  process: {
    label: 'Our Process',
  ...
  results: {
    ...
    metrics: [
      ...
      { metric: 'Email engagement rate (content-led sequences)', result: '+47% average open rate' },

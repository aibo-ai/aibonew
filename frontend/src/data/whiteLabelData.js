export const whiteLabelData = {
  slug: 'white-label',
  type: 'technology',
  pageTitle: 'White Labeled Solutions',
  eyebrow: 'White Label \u00b7 Your product, our engineering.',
  headline: 'Launch your platform. Keep your brand.',
  subheadline: "We build production-grade AI-powered products that you take to market as your own, fully branded, fully yours. No co-branding. No attribution. Just your product, powered by us.",
  ...
  deliverables: {
    label: 'What We Build',
    headline: 'Everything you need to launch your platform.',
    cards: [
      { title: 'White Label AI Platforms', body: 'Your product. Our infrastructure. Customer-facing AI tools, dashboards, and portals built to your specification and branded entirely as yours. Your clients never know we exist.' },
      ...
      { title: 'API & Integration Layers', body: 'Connect your product to anything. We build the plumbing that makes your platform work like CRM connectors, payment gateways, data pipelines, third-party APIs. Clean, documented, maintainable.' },
  ...
  whyNow: {
    label: 'Why White Label',
    headline: 'Speed, scale, and complete discretion.',
    stats: [
  ...
  results: {
    ...
    headline: 'Platforms that launch fast and scale further.',
    metrics: [
    ...
    testimonial: {
      quote: "We needed a branded client portal with reseller capabilities fast. MyAibo delivered a fully white-labelled platform in under 10 weeks, with unlimited reseller seat architecture and a 70% reduction in manual operational effort. Complete discretion, complete ownership.",
      author: 'CTO',
